========================================================================
   GrafikServerClientAnwendung : 
   GrafikServerClientAnwendung1-Projektübersicht
========================================================================

Dieses GrafikServerClientAnwendung1-Projekt wurde für Sie vom 
GrafikServerClientAnwendung als Ausgangspunkt erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihr Projekt besteht.

GrafikServerClientAnwendung1.vcxproj
    Dies ist die Hauptprojektdatei für Projekte, die mit dem 
    Anwendungs-Assistenten generiert werden. 
    Sie enthält Informationen über die Version des Produkts, mit dem die 
...
GrafikServerClientAnwendung1.vcxproj.filters
